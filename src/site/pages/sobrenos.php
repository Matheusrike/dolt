 <?php
include '../backend/sobrearrays.php';
 ?> 
...
<body>
        ...
        <div class="content-container">
            ...
            <div class="text-container">
                ...
                <div class="initial-btndiv">
                    <a href="https://github.com/Matheusrike/Dolt"><button class="btn-nossoprojeto">Nosso Projeto</button></a>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="equipe-section">
        ...
        <div class="equipe-minicont2">
            ...
            <button class="btn-repositorio"><a href="https://github.com/Matheusrike/Dolt">Repositório do Github</a></button>
        </div>
    </section>
</body>
<?php
